...
$albums = get('/users/nevesfilms/albums');
$videos = [];
$videoAlbum = [];

foreach($albums as $album) {
    $videosAlbum = get($album->metadata->connections->videos->uri);
    foreach($videosAlbum as $video){
        $videoAlbum[$video->resource_key] = $album->resource_key;
    }
...
function get($route)
{
    ...
    curl_setopt_array($curl,
        [
            CURLOPT_URL => "https://api.vimeo.com$route",
...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-135902807-2"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'UA-135902807-2');
    </script>
...
<div class="body">
    <header id="header" class="header-transparent header-with-borders-dark header-effect-shrink"
            data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 30}">
                ...
                <div class="header-row">
                    <div class="header-column justify-content-start">
                        <div class="header-logo border-left-0 px-4 d-lg-none">
                            <a href="#">
                                <img src="images/logo.svg" alt="Logomarca do site" data-change-src="images/logo.svg"
                                     width="55" height="55" alt="" style="z-index:1"/>
                            </a>
                        </div>
                        <ul class="header-social-icons social-icons social-icons-transparent social-icons-icon-light border-left-0 d-none d-lg-flex px-2 px-xl-4">
                            <li class="social-icons-facebook"><a href="<?= $facebook ?>" target="_blank"
                                                                 title="Facebook"><i
                                            class="fab fa-facebook-f"></i></a></li>
                            <li class="social-icons-twitter"><a href="<?= $vimeo ?>" target="_blank" title="Vimeo"><i
                                            class="fab fa-vimeo"></i></a></li>
                            <li class="social-icons-instagram"><a href="<?= $instagram ?>" target="_blank"
                                                                  title="Instagram"><i
                                        ...
                                        <li class="d-none d-lg-flex px-4">
                                                <span class="header-logo border-0">
                                                    <a href="#header" data-hash>
                                                        <img src="images/logo.svg" data-change-src="images/logo.svg"
                    ...
                    <div class="header-column justify-content-end">
                        <div class="header-button d-none d-sm-flex border-right-0 px-2 px-xl-4">
                            <a href="<?= $linkWhats ?>"
                               class="btn btn-outline btn-rounded btn-light btn-sticky-primary btn-4 btn-icon-effect-1">
                                    <span class="wrap">
                                        <span><?= $telefone ?></span>
                        ...
                        <button class="header-btn-collapse-nav header-btn-collapse-nav-light on-sticky-dark mx-3"
    ...
    <div role="main" class="main">
        <div class="slider-container slider-container-height-720 rev_slider_wrapper">
            <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.7" data-plugin-revolution-slider
                 data-plugin-options="{'delay': 9000, 'gridwidth': [1140,960,720,540], 'gridheight': [720,720,720,720], 'disableProgressBar': 'off', 'responsiveLevels': [4096,1200,992,576], 'navigation' : {'arrows': { 'enable': true, 'style': 'slider-arrows-style-1' }, 'bullets': {'enable': false, 'style': 'bullets-style-1', 'h_align': 'center', 'v_align': 'bottom', 'space': 7, 'v_offset': 35, 'h_offset': 0}}}">
                <ul>

                    <li class="slide-overlay slide-overlay-level-0" data-transition="slideleft">
                        <img src="imagesCompressed/slides/igreja.jpg" alt="" data-bgposition="center center"
                             data-bgfit="cover" data-bgrepeat="no-repeat" data-duration="3000"
                             data-offsetstart="250 100" class="rev-slidebg">

                        <h1 class="tp-caption text-color-light font-primary" data-x="center" data-y="center"
                            data-voffset="['-55','-55','-55','0']"
                            data-start="1000" data-fontsize="['65','65','65','55']"
                            data-transform_in="y:[-50%];opacity:0;s:500;"
                            data-transform_out="y:[-50%];opacity:0;s:500;">Neves Films
                        </h1>

                        <div class="tp-caption text-color-light font-primary font-weight-light" data-x="center"
                             data-y="center" data-voffset="['10','10','10','70']"
                             data-start="1300" data-fontsize="['37','37','37','29']"
                             data-transform_in="y:[-50%];opacity:0;s:500;"
                             data-transform_out="y:[-50%];opacity:0;s:500;">A sua empresa reconhecida
                        </div>
                        ...
                        <a class="tp-caption layer-border-width-1 popup-vimeo btn btn-light btn-outline rounded-circle d-flex align-items-center justify-content-center"
                           href="https://vimeo.com/288411014" data-x="center" data-y="center"
                           data-voffset="['150','150','150','200']"
                           data-width="90" data-height="90" data-start="1900" data-fontsize="['22','22','22','22']"
                    ...
                    <li class="slide-overlay slide-overlay-level-0" data-transition="slideleft">
                        <img src="imagesCompressed/slides/jakob-owens-198234-unsplash.jpg" alt=""
                             data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"
                             data-duration="3000" data-scalestart="100" data-scaleend="150" data-offsetstart="250 100"
                             class="rev-slidebg">

                        <h1 class="tp-caption text-color-light font-primary pl-3" data-x="left"
                            data-hoffset="['100','0','0','0']" data-y="center"
                            data-voffset="['150','0','0','0']" data-start="1000" data-fontsize="['40','40','40','40']"
                            data-transform_in="y:[+100%];opacity:0;s:500;"
                            data-transform_out="y:[-50%];opacity:0;s:500;">Tecnologia de ponta</h1>

                        <div class="tp-caption text-color-light font-primary font-weight-light pl-3" data-x="left"
                             data-hoffset="['100','0','0','0']"
                             data-y="center" data-voffset="['205','10','10','70']" data-start="1500"
                             data-fontsize="['24','24','24','29']"
                             data-transform_in="y:[-50%];opacity:0;s:500;"
                             data-transform_out="y:[-50%];opacity:0;s:500;">Vídeos
                            em 4k
                        </div>
                    ...
                    <li class="slide-overlay slide-overlay-level-0" data-transition="slideleft">
                        <img src="imagesCompressed/slides/lamp.jpg" alt="" data-bgposition="center center"
                             data-bgfit="cover" data-bgrepeat="no-repeat" data-duration="3000"
                             data-scalestart="100" data-scaleend="150" data-offsetstart="250 100" class="rev-slidebg">

                        <h1 class="tp-caption text-color-dark font-weight-bold font-primary pr-3" data-x="right"
                            data-hoffset="['100','0','0','0']"
                            data-y="center" data-voffset="['150','0','0','0']" data-start="1000"
                            data-fontsize="['40','40','40','40']"
                            data-transform_in="y:[-100%];opacity:0;s:500;"
                            data-transform_out="y:[-50%];opacity:0;s:500;">Criatividade
                            para inovar</h1>

                        <div class="tp-caption text-color-dark font-primary font-weight-light pr-3" data-x="right"
                             data-hoffset="['100','0','0','0']"
                             data-y="center" data-voffset="['205','10','10','70']" data-start="1500"
                             data-fontsize="['24','24','24','29']"
                             data-frames='[{"from":"opacity:0;","speed":300,"to":"o:1;","delay":1200,"split":"chars","splitdelay":0.05,"ease":"Power2.easeInOut"},{"delay":"wait","speed":1000,"to":"y:[100%];","mask":"x:inherit;y:inherit;s:inherit;e:inherit;","ease":"Power2.easeInOut"}]'>
                            Conheça
                            nossos vídeos
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="lead mb-3 appear-animation animated fadeInUpShorter appear-animation-visible"
                           data-appear-animation="fadeInUpShorter"
                           data-appear-animation-delay="300" style="animation-delay: 300ms;">Precisa gravar vídeos com
                            qualidade profissional,
                            para comerciais, redes sociais e cobertua de eventos?</p>

                        <p class="text-color-light-4 mb-3 appear-animation animated fadeInUpShorter appear-animation-visible"
                           data-appear-animation="fadeInUpShorter"
                        ...
                        <a href="<?= $linkWhats ?>"
                           ...
                           style="animation-delay: 700ms;">Contato</a>
                    </div>
            ...
            <div class="container pb-3 pt-5">
                <div class="row mt-5">
                    <div class="col-md-12">
                        ...
                        <p class="lead mb-3 appear-animation animated fadeInUpShorter appear-animation-visible"
                           data-appear-animation="fadeInUpShorter"
                           data-appear-animation-delay="300" style="animation-delay: 400ms;">Profissionais experientes e
                            com desejo de fazer o melhor trabalho. Conheça os integrantes dessa equipe:
                        </p>

                        <div class="owl-carousel owl-theme nav-style-3"
                             data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '768': {'items': 2}, '979': {'items': 3}, '1199': {'items': 5}}, 'dots': false, 'nav': true, 'animateIn': 'fadeIn', 'animateOut': 'fadeOut', 'margin': 30}">
                                ...
                                <div>
                                    ...
                                    <div class="image-frame image-frame-style-1 image-frame-effect-2 image-frame-effect-1">
                                        <div class="image-frame-wrapper image-frame-wrapper-overlay-bottom image-frame-wrapper-align-end">
                                            <img src="imagesCompressed/team/<?= $person->image ?>" class="frame-shadow"
                                                 alt="">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="owl-carousel owl-theme nav-style-3 owl-loaded owl-drag owl-carousel-init"
                         data-plugin-options="{'responsive': {'0': {'items': 1}, '479': {'items': 1}, '768': {'items': 2}, '979': {'items': 3}, '1199': {'items': 3}}, 'dots': false, 'nav': true, 'animateIn': 'fadeIn', 'animateOut': 'fadeOut', 'margin': 30, 'autoplay': true, 'autoplayHoverPause':true}">
        ...
        <section class="section bg-dark-2" id="albumns">
            <div class="container">
                ...
                <div class="row align-items-center mb-4 appear-animation animated fadeInUpShorter appear-animation-visible"
                    ...
                    <div class="col-12">
                        <ul id="portfolioLoadMoreFilter"
                            class="nav nav-light-2 sort-source justify-content-center justify-content-md-start mb-4 mb-md-0"
                            data-sort-id="portfolio" data-option-key="filter"
                            data-plugin-options="{'layoutMode': 'fitRows', 'filter': '*'}">
                            <li class="nav-item" data-option-value="*"><a href="#" class="nav-link active">TODOS</a>
                            </li>
                            <?php
                            foreach ($albums as $album) : ?>
                                <li class="nav-item" data-option-value="<?= $album->resource_key ?>"><a class="nav-link text-uppercase" href="#"><?= $album->name ?></a></li>
                            <?php
                            endforeach;
                            ?>
                        </ul>
                ...
                <div class="row appear-animation appear-animation-visible"
                     data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1500"
                     style="animation-delay: 1500ms;">
                    <div class="col-12 p-0">
                        <div class="sort-destination-loader bg-dark p-2 sort-destination-loader-loaded">
                            <ul id="portfolioLoadMoreWrapper" class="portfolio-list sort-destination" 
                                data-sort-id="portfolio" data-total-pages="2" data-filter="*">
                                ...
                                foreach ($videos as $video) :
                                    ...
                                    $videoNameShort = strlen( $videoName ) > 40 ? substr($videoName, 0, 40) . '...' : $videoName;
                                    ...
                                    <li class="col-12 col-md-6 col-lg-4 p-0 isotope-item <?= $videoAlbum[$video->resource_key] ?>">
                                        <div class="portfolio-item appear-animation animated fadeInUpShorter appear-animation-visible">
                                            <article class="blog-post">
                                                ...
                                                <div class="image-frame frame-shadow">
                                                    <div class="image-frame-wrapper">
                                                        <a href="<?= $linkVimeo ?>" class="popup-vimeo">
                                                            <img src="<?= $picture ?>" class="img-fluid" alt="<?= $videoName ?>"/>
                                                        </a>
                                                    </div>
                                                </div>
                                                <div class="d-flex opacity-6 my-2">
                                                    <span class="post-likes d-flex align-items-center pr-3">
                                                        <i class="text-color-light font-weight-bold lnr lnr-heart text-3 mr-1 " aria-label="<?= $contentRating ?> users like this video" title="<?= $contentRating ?> avaliações"></i>
                                                    ...
                                                    <span class="post-likes d-flex align-items-center border border-grey border-top-0 border-bottom-0 border-left-0 pr-3">
                                                        <i class="text-color-light font-weight-bold lnr lnr-film-play text-3 mr-1" title="<?= $plays ?> visualizações" aria-label="<?= $plays ?> users played this video"></i>
                                                    <span class="text-color-light font-weight-bold">
                                                    <?= $plays ?>
                                                    </span>
                                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 mb-4 mb-lg-0">
                        ...
                        <p>A NevesFilms terá prazer em lhe atender. Abaixo estão nossas informações de endereço, 
                        atendimento via Whatsapp e e-mail. </p>
                        <ul class="list list-icon list-unstyled">
                            <li class="mb-2"><i class="fas fa-angle-right mr-2 ml-1"></i> <span
                                        class="text-color-light">Endereço:</span>Atitude Centro Empresarial <br> Rua São
                                José, nº 253, 4 andar, Sala 407, Gaspar/SC
                            </li>
                            <li class="mb-2"><i class="fas fa-angle-right mr-2 ml-1"></i> <span
                                        class="text-color-light">Whatsapp:</span> <a
                                        href="https://api.whatsapp.com/send?phone=5547997436800"><?= $telefone ?></a>
                            </li>
                            <li class="mb-2"><i class="fas fa-angle-right mr-2 ml-1"></i> <span
                                        class="text-color-light">Email:</span> <a
                                        href="mailto:contato@nevesfilms.com.br" class="link-underline-light">contato@nevesfilms.com.br</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-3">
                        ...
                        <div class="card rounded bg-dark-2 border-0">
                            ...
                            <div class="pt-2">
                                ...
                                <p class="mb-0">Estamos localizados no centro da cidade de Gaspar. Venha conhecer nosso
                                    trabalho!</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row text-center text-md-left align-items-center">
                        <div class="col-md-7 col-lg-8">
                            <ul class="social-icons social-icons-transparent social-icons-icon-light social-icons-lg">
                                ...
                                <li class="social-icons-twitter"><a href="<?= $vimeo ?>" target="_blank"
                                                                    title="Twitter"><i class="fab fa-vimeo"></i></a>
                                </li>
                                <li class="social-icons-instagram"><a href="<?= $instagram ?>" target="_blank"
